...
def byWhatEPlusOneVectorDominateOther(vector1, vector2):			# vector1 dominate vector2; used in SpacingDistributionInEPlus indicator
	e1 = vector1[0] - vector2[0]			# e in first component
	e2 = vector1[1] - vector2[1]			# e in first component
	if e1 < 0:
		e1 = 0
	if e2 < 0:
		e2 = 0
